    ...
    try:
        ...
        if analysis:
            ...
            detail_data["analysis_result"] = {
                ...
                "price_difference_rate": float(api_response.get('price_difference_rate')) if api_response.get('price_difference_rate') is not None else None,
                "base_unit_price": float(api_response.get('base_unit_price')) if api_response.get('base_unit_price') is not None else None,
                "unit_conversion": api_response.get('unit_conversion'),
